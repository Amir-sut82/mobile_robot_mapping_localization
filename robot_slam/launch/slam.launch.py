"""
Launch file for the custom SLAM system.

This launch file starts:
1. SLAM Node - Performs localization and mapping
2. Map Saver Node - Saves the generated map to disk

Usage:
    ros2 launch robot_slam slam.launch.py
    ros2 launch robot_slam slam.launch.py use_scan_matching:=true map_resolution:=0.05
"""
